...
original_name="flpt"
original_urlname="flpt"
original_description="Awesome flpt created by mbaneshi" 
...
then
    ...
    echo "then run 'flpt' or 'python -m flpt'"
else
    poetry install
    echo "Applied Flask template"
    echo "Ensure you activate your env with 'poetry shell'"
    echo "then run 'flpt' or 'python -m flpt' or 'poetry run flpt'"
fi
